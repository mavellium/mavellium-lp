                ...
                <div className="container">
                    <div className="text-center text-white space-y-4 mb-12">
                        ...
                        <p className="text-lg max-w-3xl mx-auto">
                            Resultados reais de clientes que transformaram seus negócios com nossas landing pages
                        </p>
                    </div>
                ...
                <div className="container">
                    <div className="text-center space-y-4 mb-12">
                        ...
                        <p className="text-lg max-w-3xl mx-auto text-white">
                            Depoimentos reais de empresas que aumentaram suas conversões conosco
                        </p>
                    </div>
