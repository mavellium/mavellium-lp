           ...
           <Header></Header>
            ...
            <section className="py-16 w-full flex flex-col justify-center items-center bg-[#0C2136] md:py-24" id="servicos">
                <div className="container w-full flex flex-col justify-center items-center">
                    ...
                    >
                        {/* CARD 1 */}
                        <Card className="group hover:shadow-lg transition-shadow w-full sm:max-w-sm h-[338px] flex flex-col bg-[#010910] border-2 border-[#397EEF] text-white space-around items-center text-center transition-all hover:scale-105">
                        ...
                        {/* CARD 2 */}
                        <Card className="group hover:shadow-lg transition-shadow w-full sm:max-w-sm  h-[338px] flex flex-col bg-[#010910] border-2 border-[#10B981] text-white space-around items-start text-center transition-all hover:scale-105">
                            <CardHeader className="flex flex-col justify-center items-center w-full">
                                ...
                                <CardTitle className="text-[20px]">SEO <span className="block">Otimizado</span></CardTitle>
                            </CardHeader>
                            <CardContent className="flex flex-col justify-center items-center">
                                <p className="text-muted-foreground text-center">
                        ...
                        {/* CARD 3 */}
                        <Card className="group hover:shadow-lg transition-shadow w-full sm:max-w-sm  h-[338px] flex flex-col bg-[#010910] border-2 border-[#6366F1] text-white space-around items-center text-center transition-all hover:scale-105">
                            <CardHeader className="flex flex-col justify-center items-center w-full">
                        ...
                        {/* CARD 4 */}
                        <Card className="group hover:shadow-lg transition-shadow w-full sm:max-w-sm h-[338px] flex flex-col bg-[#010910] border-2 border-[#F97316] text-white space-around items-center text-center transition-all hover:scale-105">
                            <CardHeader className="flex flex-col justify-center items-center w-full">
