...
export function Headline() {
  return (
    <section className="relative w-full flex flex-col h-screen justify-center items-center overflow-hidden bg-gradient-to-br from-[#041526] via-[#1F3E5D] to-[#041526] py-20 md:py-32">
